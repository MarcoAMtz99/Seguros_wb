	            	...
	            	<div class="tab-pane fade show active" id="pills-Amplia" role="tabpanel" aria-labelledby="pills-Amplia-tab">
	            		<div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" v-if="cliente.gnp">
                                                    <div v-if="cotizacionesGNP && cotizacionesGNP.PAQUETES !== undefined" style="padding">
                                                        ...
                                                        <div class="border">{{ cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[1].DESC_PERIODICIDAD }}: 1er pago ${{ cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[1].CONCEPTO_ECONOMICO[11].MONTO | int }}<br>Subsecuentes x 1: ${{cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[1].CONCEPTO_ECONOMICO[11].MONTO}} </div>
                                                        <div class="border">{{ cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[2].DESC_PERIODICIDAD }}: 1er pago ${{ cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[2].CONCEPTO_ECONOMICO[11].MONTO | int }} <br> Subsecuentes x 3: ${{cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[2].CONCEPTO_ECONOMICO[11].MONTO}}</div>

                                                        <div class="border">{{cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[3].DESC_PERIODICIDAD }}:1er pago .${{ cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[3].CONCEPTO_ECONOMICO[11].MONTO | int }} <br> Subsecuentes x 11: ${{cotizacionesGNP.PAQUETES.PAQUETE.TOTALES.TOTAL_PRIMA[3].CONCEPTO_ECONOMICO[11].MONTO | int}} </div>
                                                    </div>
                                                    <div v-else>
                                                ...
                                                <td class="text-center" v-if="cliente.qualitas">
                                                    ...
                                                    <div class="text-center" v-if="cotizacionesQualitasT['Recibos'][0]">
                                                        <div v-for="(cobertura,index) in cotizacionesQualitasT['Recibos']" >
                            ...
                            <div class="text-center" v-if="desc_gnp && tipo_poliza && cotizacionesGNP && cotizacionesGNP.PAQUETES !== undefined" style="padding:0">
                                                ...
                                                <td class="text-center" v-if="cliente.gnp">
                                                    <div class="text-center" v-if="desc_gnp && tipo_poliza && cotizacionesGNP && cotizacionesGNP.PAQUETES !== undefined" >
                                                        <div v-for="(cobertura,index) in cotizacionesGNP.PAQUETES.PAQUETE.COBERTURAS.COBERTURA" v-if="cobertura.NOMBRE == 'GASTOS MEDICOS OCUP                               '">
                                                            ...
                                                            <div v-else><strong></strong> {{cobertura.SUMA_ASEGURADA}}</div>
                                                        </div>
                                                    </div>
                                                    <div v-else class="text-center">
                                                        Seleccione una descripción
                                ...
                                {{cotizacionesGNP.PAQUETES.PAQUETE.COBERTURAS.COBERTURA[cotizacionesGNP.PAQUETES.PAQUETE.COBERTURAS.COBERTURA.length-1].NOMBRE}} </strong>
