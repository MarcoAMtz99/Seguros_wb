    ...
    <body>
        ...
        <div class="row bg-info2 text-white p-4 footer">
            ...
            <div class="col-12 col-sm-3">
                ...
                <p class="text-center"><a href="https://www.facebook.com/autosegurodirecto" target="_blank"><i class="fab fa-facebook-square f-social"></i></a><a href="https://twitter.com/autosegurodirecto" target="_blank"><i class="fab fa-twitter-square f-social " ></i></a></p>
            </div>
